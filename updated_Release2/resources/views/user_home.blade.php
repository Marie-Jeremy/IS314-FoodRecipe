...
<div class="listing">
    ...
    <div class="detail">
        ...
        <div class="meta-listing">
            ...
            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#recipeCollapse{{ $recipe->id }}" aria-expanded="false" aria-controls="recipeCollapse{{ $recipe->id }}">
                View Recipe Details
            </button>
        </div>
    </div>
</div>
<div class="collapse" id="recipeCollapse{{ $recipe->id }}">
    <div class="card card-body">
        <!-- Full recipe details here -->
        <p>{{ $recipe->content }}</p>
        <!-- Ingredients, steps, and other details can be added here -->
    </div>
            @for ($i = 1; $i <= 5; $i++)
    ...
    $('.rating-form').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // For example, reload the recipe list or update the rating display
            },
            error: function(xhr) {
