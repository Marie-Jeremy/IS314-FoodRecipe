            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="/submit-recipe">Submit Recipes</a>
                        </li>
                        <li>
            ...
            <div class="row">
                <section class="col-sm-7 col-md-8 col-lg-8">
                    <div class="intro">
                        ...
                        <p>Protect your travels with our comprehensive travel insurance coverage. Whether you're exploring new destinations or relaxing on the beach, we've got you covered.</p>
                        <ul class="row">
                            <li class="col-sm-4">
